...
<div class="contentContainer">
    ...
    <h1>Здравейте, ние сме Нина и Роси!</h1>
    <div style="margin: 2vw 0vw; display: flex;align-items: center;flex-wrap: wrap;justify-content: center;">
      <img src="images/about/nina.webp" title="Нина" class="profileImage framed framedLeft" alt="Игралница Занималница - Детски учебен център и занималня в гр. Варна | Снимка на Нина" style="display: inline;">
      <img src="images/about/rosi.webp" title="Роси" class="profileImage framed framedRight" alt="Игралница Занималница - Детски учебен център и занималня в гр. Варна | Снимка на Роси" style="display: inline;">
    </div>
    <div>
  ...
  </div>`,contactsHTML=`<p><h1>Как да се свържете с нас?</h1>
<address>
<b>Николина Богданова</b> - управител, учител, утешител, укротител и разрешител на всякакви проблеми <br>
