...
const mainContent = {
  ...
  const metaDescriptions = {
    '/': 'Добре дошли в Игралница Занималница! Опитайте нашата училищна занималня и лятна игралница за деца от 1 до 5 клас, както и подготвителните групи към училищата - вълнуващо детство гарантирано!',
    '/училищна-занималня': 'Открийте какво включва училищната занималня - програма, цени и как минава един ден с нас.',
    '/лятна-игралница': 'Изживейте лятната радост в нашата игралница! Приключенска програма, цена и често задавани въпроси за лятната игралница.',
